...
public final class MistralAgent implements Helper {
    ...
    private static final String SYSTEM_PROMPT =
            ...
            + "- Plan crafting around what you actually have: get_state shows inventory_totals AND ender_chest_totals; call get_ender_chest "
            + "for the player's stored ender chest items. Do not assume materials you have not verified.\n"
